...
int make_square(int a, int b){ 
    ...
    int cnt1 = is_in(min_x, min_x + l, min_y, min_y + l);
    int cnt2 = is_in(min_x, min_x + l, max_y - l, max_y);
    int cnt3 = is_in(max_x - l, max_x, min_y, min_y + l);
    int cnt4 = is_in(max_x - l, max_x, max_y - l, max_y);
